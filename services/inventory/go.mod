module refurbished-marketplace/services/inventory
...
replace refurbished-marketplace/shared/testutil/kafka => ../../shared/testutil/kafka

replace refurbished-marketplace/shared/testutil/postgres => ../../shared/testutil/postgres
