...
const file_users_v1_users_proto_rawDesc = "" +
	"\n" +
	"\x14users/v1/users.proto\x12\busers.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"E\n" +
...
var (
	file_users_v1_users_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
	file_users_v1_users_proto_goTypes  = []any{
