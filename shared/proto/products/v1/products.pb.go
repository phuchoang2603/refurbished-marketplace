...
const file_shared_proto_products_v1_products_proto_rawDesc = "" +
	...
	"\bproducts\x18\x01 \x03(\v2\x14.products.v1.ProductR\bproducts2\x88\x02\n" +
	...
	"\x10GetProductsByIDs\x12$.products.v1.GetProductsByIDsRequest\x1a%.products.v1.GetProductsByIDsResponseBVZTgithub.com/phuchoang2603/refurbished-marketplace/shared/proto/products/v1;productsv1b\x06proto3"
...
var file_shared_proto_products_v1_products_proto_depIdxs = []int32{
	...
	3, // 5: products.v1.ProductsService.GetProductsByIDs:input_type -> products.v1.GetProductsByIDsRequest
	...
	4, // 8: products.v1.ProductsService.GetProductsByIDs:output_type -> products.v1.GetProductsByIDsResponse
