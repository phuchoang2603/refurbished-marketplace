...
func (c *inventoryServiceClient) GetStock(ctx context.Context, in *GetStockRequest, opts ...grpc.CallOption) (*Stock, error) {
...
func (c *inventoryServiceClient) GetStocksByIDs(ctx context.Context, in *GetStocksByIDsRequest, opts ...grpc.CallOption) (*GetStocksByIDsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetStocksByIDsResponse)
	err := c.cc.Invoke(ctx, InventoryService_GetStocksByIDs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedInventoryServiceServer) GetStock(context.Context, *GetStockRequest) (*Stock, error) {
...
func _InventoryService_GetStocksByIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStocksByIDsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServiceServer).GetStocksByIDs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InventoryService_GetStocksByIDs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).GetStocksByIDs(ctx, req.(*GetStocksByIDsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
