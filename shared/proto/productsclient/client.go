...
func (c *Client) CreateProduct(ctx context.Context, name, description string, priceCents int64, merchantID, terminalID string, xPos, yPos float64) (*productsv1.Product, error) {
