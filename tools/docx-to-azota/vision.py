...
def load_unimernet(cfg_path: str | Path | None = None, device: str | None = None, fp16: bool = True):
    ...
    from compat_transformers import patch_unimernet_kv_cache

    patch_unimernet_kv_cache(model)
...
def unimernet_batch(
    ...
    preds: dict[str, str] = {}
    from compat_transformers import restore_get_head_mask, patch_unimernet_kv_cache
