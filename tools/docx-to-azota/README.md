...
Colab: upload `colab_start_here.ipynb` sau khi **Disconnect and delete runtime**. Phần A extract Azota không cài UniMERNet, **không Google Drive**. Không dùng Untitled1 / `unimernet[full]` / `tokenizers`.
